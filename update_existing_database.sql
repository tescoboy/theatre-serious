-- Update existing Supabase database to match app requirements
-- This will create a simple plays table that your app expects
...
-- Drop the existing plays table if it has the wrong structure
DROP TABLE IF EXISTS plays CASCADE;

-- Create the simple plays table that your app expects
CREATE TABLE plays (
...
CREATE INDEX idx_plays_date ON plays(date DESC);
CREATE INDEX idx_plays_rating ON plays(rating);
CREATE INDEX idx_plays_standing_ovation ON plays(standing_ovation);
